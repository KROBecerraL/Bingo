...
var recorrido = []; //array para los números aleatorios que ha escogido el sistema
var muestra = []; //array que contiene los 75 números aleatorios de los que se puede escoger
var marcados = []; //array para los números marcados por el usuario
